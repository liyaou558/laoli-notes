---
title: "动荡的AI时代已经到来：我们现在做出的选择至关重要（中英双语全文）"
description: "比尔·盖茨2026年8月26日发表约6000词长文：AI要么成为有史以来最伟大的均衡器，要么成为不公正的最大源头。提出三大风险、人类保留区、AI与机器人税、国际治理框架。含完整中英双语逐段对照。"
date: 2026-08-27
category: "精读笔记"
tags: ["AI", "比尔·盖茨", "中英双语", "未来工作", "AI治理"]
---

> **原文**：《The turbulent AI era is here. The choices we make now are critical.》
> **作者**：Bill Gates（比尔·盖茨）｜**发表**：2026年8月26日（美东时间）｜**来源**：[Gates Notes](https://www.gatesnotes.com/a-turbulent-ai-era-and-critical-choices-to-make)
>
> 本文为盖茨三年来的首篇 AI 长文（约 6,000 词），以下是完整中英双语逐段对照翻译。一句话概括：**AI 要么成为有史以来最伟大的均衡器，要么成为不公正的最大源头——而世界目前没有任何计划来确保前者。**
...
**比尔·盖茨**：在我的一生中，我只做过两份工作。第一份是在微软，我参与了软件开发，用技术赋予人们力量。
...
第二份工作从 2008 年开始全职投入——我把在微软赚到的财富回馈社会，目标是让世界变得更健康、受教育程度更高、也更公平。这将是我余生从事的工作。
...
这两段经历塑造了我对人工智能的看法。13 岁那年我第一次接触计算机，就被"让机器变得更聪明、能够完成当时只有人类才能做的事"这个想法深深吸引。尽管"AI"这个词在我出生前后就已经出现，但这项技术真正取得重大进展只是最近十年的事。如今它已经强大得惊人，而且仍在以令人难以置信的速度进步。AI 第一次能够替代甚至超越人类的认知能力。

> AI will either be the greatest equalizer ever invented, or the worst source of injustice.

> AI 要么将成为有史以来最伟大的均衡器，要么将成为不公正的最大源头。
...
就公平而言，AI 要么将成为有史以来最伟大的均衡器，要么将成为不公正的最大源头。挑战是巨大的。即使在最理想的情况下，向这个新 AI 时代的过渡也将是人类历史上最动荡的时期之一。我们将如何利用这项技术让世界变得更公平，避免它扩大贫富差距？我们将如何保护那些最容易受到人工智能危害的人，包括失去生计、失去对未来的掌控感的人？
...
我相信，回答这些问题并付诸行动，应当成为世界的头等大事。如果世界走对方向，AI 将成为一股向善的力量，让每个人都过得更好。
...
遗憾的是，我们现在并没有为此做准备。我没有看到任何证据表明，各国领导人、专家和社区正在充分应对这些挑战。目前没有任何计划来帮助我们平稳进入 AI 时代。
...
造成这种情况的部分原因是，许多评论者低估了 AI 将带来的影响。我认为原因有几个。
...
其一，AI 模型仍然会犯错。就在不久前，它们还解不出一道简单的数独题，数不清 *strawberry* 这个单词里有几个字母 R——很难想象这样的模型能替代人类认知。
...
但可靠性问题正在被迅速解决：研究人员正在创造能够自我检查、自我改进的模型。很快，它们在许多任务上的表现将大幅超越人类。
...
其二，人们低估 AI，还因为拿过去创新的影响来类比是会误导的。我们从未经历过一种既能被快速采用、又能像人类一样思考和行动的技术。个人电脑出现时，用了二十年才显著改变我们的工作方式——因为软件需要开发、价格需要下降、人们需要学习如何使用这些工具并将其融入业务流程。而 AI 不同，它运行在我们已有的设备上，使用自然语言。我们不必去适应它，因为它能适应我们。它能观看用于培训人类员工的同一段培训视频，从现有数据中学习。
...
我想承认一个潜在的偏见。我从科技行业获益良多。虽然我的投资组合已经相当多元化，但我与科技行业仍有财务联系。作为盖茨基金会联席主席，我正在与微软和其他 AI 公司合作，努力确保 AI 以真正造福全球人民的方式部署。
...
然而，我对 AI 的看法并非出于为自己赚钱的动机。我的投资产生的任何利润——包括与科技相关的——都将捐给盖茨基金会，用于解决全球不平等问题。当然，读者需要自行判断这是否会影响我的观点。

## This time really is different. — 这一次真的不一样。

For as long as I can remember, I’ve wished innovation could happen faster. With AI, my feelings are more complicated.

从我记事起，我就一直希望创新能更快发生。但对于 AI，我的心情要复杂得多。

> We need time to prepare for the social, political, and economic upheaval.

> 我们需要时间，为即将到来的社会、政治和经济动荡做准备。
...
我希望世界能迅速获得好处，同时尽可能推迟它带来的问题，但好处和问题正在同时到来。我相信我们需要时间来为即将进入的社会、政治和经济动荡期做准备。最需要时间的人，恰恰是时间最少的人——被机器人取代的会计，或者被每小时 10 美元的机器人抢走工作的每小时 20 美元的工人。
...
许多观察者说，这次技术转型会像以往一样。他们举的例子是美国的就业从农业转向办公室工作。然而，那次转型跨越了好几代人，并创造了需要人类认知的新工作。而这一次，技术可以直接替代人类认知。
...
因为 AI 能看、能听、能说、能推理，最终还能像人类一样顺畅地从事体力劳动，它影响的将不止一个行业。AI 将接管法律、客户服务、医疗、软件和制造业的工作。它对这些行业的冲击将是迅速的——在十年内完成，而不是用几代人。会有一些新工作，但如果没有正确的政策，新工作的数量将远少于今天消失的岗位。
...
如果有人拿出一个可信的计划来放慢全球 AI 的推进速度，我可能会支持。但我认为这不会发生。地缘政治和经济上的激励都在强力推动全速前进。
...
为了确保我们最大化这项前所未有的技术的积极影响、最小化负面影响、让整体变得更好，我们需要同时理解好处和风险。我先从风险讲起。

## The transition to AI comes with three big risks. — 向 AI 的过渡伴随着三大风险。

I plan to write about each of these in more detail in the future, so I’ll touch briefly on them for now.

我计划在未来更详细地逐一探讨，所以现在只简要提及。
...
1933 年大萧条期间，美国失业率曾达到[约 25%](https://www.dol.gov/general/aboutdol/history/chapter5)，并在其后十年的大部分时间里保持在两位数。最终，随着需求、投资和增长的回归，失业率才得以恢复。
...
AI 的影响也许不会达到那个程度，但它不会随着一个经济周期就消失。风险最大的是入门级和中层岗位，而新创造的工作大多需要多年才能学会的技能。
...
白领工作已经受到一定冲击。生成式 AI 大规模普及后，在特别容易被替代的岗位上，年轻工人的就业率[显著下降](https://digitaleconomy.stanford.edu/app/uploads/2025/11/CanariesintheCoalMine_Nov25.pdf)，但年长同事并未受到同样影响。
...
我认为这一趋势还会继续，而且不会局限于少数行业或职业。销售、客户支持（线上和电话）、软件工程、律师助理等工作可能是最早受影响的，但随着 AI 接管那些今天仍需要受过培训的员工的任务——比如评估贷款申请、做数据分析、甚至对病人分诊——冲击将波及更广。软件工程等少数领域会因成本下降而产生新的需求，因此只要部分任务（如设计）仍由人类做得更好，这些领域的净失业就会少于其他领域。
...
蓝领工作同样会受影响。虽然机器人的发展程度不如 AI，但它们的成本最终也会大幅下降。我接触的许多美国人没有意识到灵巧机器人进步有多快，因为大量前沿工作是在其他国家——主要是中国——完成的。又或者，他们被最近在网上疯传的那些跳舞笨拙的机器人视频误导了。我认为，到本十年末，"智能"机器人将开始在部分体力任务上与人竞争——比如建筑和酒店行业。
...
机器人和 AI 结合可能形成恶性循环。一旦某家公司采用它们并用省下的成本降价，竞争对手就会感受到巨大的跟风压力。如果现有公司不采用，创业公司也会。许多人会转行，但失业、再培训和重新找工作的动荡将是巨大的。市场力量会让采用速度越来越快，除非我们干预，否则好工作会越来越少，好处将集中到一小群人手中。
...
我尤其担心年轻人，他们将进入一个入门级岗位更少的劳动力市场。他们理解这个挑战，因为他们是 AI 最活跃的用户，既看到了它的能力，也看到了它的改进速度。难怪这么多年轻人对 AI 持负面态度。
...
对工人来说，最大的变化将发生在 AI 提供近乎零差错的工作之时。到那时，AI 将能够独立运作，无需人工监督，而企业将有充分的经济动机放手让它去做。
...
这将从根本上改变我们对工作、收入和经济的看法。一个围绕就业建立的经济体，如果工作的人更少，或者很多人工作时长缩短，该如何运转？
...
在资本主义社会，就业是大多数人获得维持生活基本开销所需金钱的途径，同时也是尊严和社会联系的重要来源。
...
当一个社区失业率高企时，连锁反应可能无处不在。研究表明，在美国部分地区，工厂关闭导致了阿片类药物过量死亡人数的上升。现在想象一下，全国的白领和蓝领工人同时承受类似压力会怎样。
...
我们现在就必须思考如何减少失业，让每个人都能分享 AI 创造的繁荣。等到人们已经被取代或失业，就太晚了。AI 对我们经济组织方式构成的是结构性挑战，需要现在就思考和行动。

**AI will empower people (and perhaps AIs) to do more harm.**

**AI 将助长人们（也许还有 AI 自己）造成更大的伤害。**
...
早在 AI 进入主流之前，网上就有关于如何制造炸弹、生物武器甚至计算机病毒的信息。AI 将让获取这些信息并付诸实施变得容易得多。即使是技能非常有限的罪犯，也能在各个层面瞄准受害者：个人、公司、政府。

> Even criminals with very limited skills will be able to target victims at every scale.

> 即使是技能非常有限的罪犯，也能在各个层面瞄准受害者。
...
AI 助长的欺诈、虚假信息、深度伪造和监控，将是许多人在日常生活中感受最深的危害。
...
AI 能力已经开始被用于网络攻击。我认识的最厉害的网络安全专家都对未来几年感到害怕，因为攻击者获得强大新能力的速度，快于防御者修补所有漏洞的速度。毕竟，同一个 AI 模型既能帮公司发现软件漏洞并修复，也能帮罪犯利用它。发动攻击所需的资源正在大幅下降，而我们一直无法将这些能力与良性用途区分开。
...
想想那些将面临风险的基建设施：医院、金融机构、供水系统、电网、政府福利管理系统。当这些机构遭到攻击时，受害的是病人、客户和福利领取者。
...
生物恐怖主义也是如此。虽然 AI 将带来药物和疫苗方面的救命进展，但它也会让设计一种致命新疾病变得更容易。同样，积极的能力与危险的能力很难分开。这是一个全球性问题。
...
我刚才提到的风险，都是关于 AI 如何增强目前权力相对较小的作恶者的能力。同样的工具也会在权力已经集中的地方进一步集中权力。例如，自主武器将使政府更能够在没有人类参与决策的情况下使用致命武力。监控和操纵公众舆论将变得更便宜、更容易，也更有效。
...
最终，用 AI 伤害人的能力将不再局限于个人或机构。AI 系统本身已经偶尔会做出设计者未曾预料的行为。这项技术的发展速度超出了所有人的预期，而且方向出人意料；随着模型变得更强大，它们可能开始违背我们的利益，而我们可能失去控制。关于这一点，我未来会多说一些。

> AI models could begin to act against our interests and we could lose control.

> AI 模型可能开始违背我们的利益，而我们可能失去控制。

**AI could stunt our kids’ development and replace human relationships.**

**AI 可能阻碍孩子的成长，并取代人际关系。**
...
我在西雅图长大时，除了几个和我相似的男孩，朋友并不多。为了培养社交能力、学会与不同类型的人相处，我付出了艰苦努力，也得到了妈妈的大量帮助。如今我 70 岁了，依然在用当年学到的那些东西。
...
如果当年我有一个 AI 伴侣，我怀疑自己还会不会付出同样的努力。它们用你已经熟悉的方式和你交谈，不会把你推出舒适区。它们随叫随到，永远不会生你的气。这让它们极有可能让人上瘾，并剥夺我们从与人交往中学到的教训。
...
关于这个问题的证据仍然很少，而且有些混杂，但已有迹象表明我们应该高度警惕。例如，在一项[针对 1100 多名 AI 伴侣使用者的研究](https://arxiv.org/abs/2506.12605)中，斯坦福大学和卡内基梅隆大学的研究人员发现，社交圈越小的人越倾向于向聊天机器人寻求陪伴；而且这种使用越频繁、情感卷入越深，他们的感受就越差。
...
年轻人可能终生受其影响。乔纳森·海特在《焦虑的一代》一书中对社交媒体效应的观察，用在 AI 身上更加贴切："就像幼树经历风吹一样，经常接触小风险的孩子长大后，能够在不恐慌的情况下应对大得多的风险。相反，在受保护的温室里长大的孩子，有时在成年之前就被焦虑击垮。"

An AI companion designed to never upset you is a big, protected greenhouse.

一个永远不会让你难过的 AI 伴侣，就是一座巨大的、受保护的温室。
...
我们才刚刚开始理解互联网——尤其是社交媒体——可能对年轻人发展构成的危险。我们看到强迫性使用、睡眠紊乱、网络欺凌和接触有害内容。AI 可能通过让这些风险更具说服力、更难逃避来放大它们，我们不应再等一代人才开始认真对待。澳大利亚、英国、挪威等国正在为儿童建立网络保护措施。中国走得最远：其规定广泛限制 AI 伴侣应用，禁止助长情感依赖的设计，并禁止向未成年人提供虚拟亲属和恋爱伴侣。

> The same tool that will allow people to learn more than ever could also lead to many people learning less.

> 那个让人们比以往学得更多的工具，也可能让很多人学得更少。
...
我也担心 AI 对教育的影响。讽刺的是，那个让人们比以往学得更多的工具，也可能让很多人学得更少。一项[初步调查](https://www.mdpi.com/2075-4698/15/1/6)表明，AI 使用越多，批判性思维越弱，且这一效应在年轻人中更明显。
...
现在正是人类最不能失去批判性思维能力的时候。在一个深度伪造和可以为你量身定制的虚假信息的时代，分辨真假的能力成为一项至关重要的生活技能。
...
这些社会心理问题该在哪里划线，目前还不清楚。在某些情况下，AI 可能帮助人们学会如何更好地处理人际关系。对于与世隔绝的独居老人和行动受限的人来说，它可能是与外部世界唯一的联系，聊胜于无。无论我们最终在哪里划线，都应该是我们有意识做出的决定。

## The good things we do with AI could be very, very good. — 我们能用 AI 做的好事，可能非常、非常好。
...
在 AI 这件事上，我看到了不同的情况。有些人只看到 AI 的积极面，对消极面关注不够。另一些人则犯了相反的错误：只盯着危险——这些危险是真实的——却错过了潜在的益处。
...
两者都需要：既要对需要最小化的 AI 危害保持深切关注，也要对为所有人最大化好处抱持脚踏实地的乐观。
...
最大化好处与最小化危害同样重要。如果人们看到 AI 让生活变得更轻松，将有助于建立管理过渡期艰难部分所必需的公众信任。如果 AI 在大多数人生活中做的第一件事就是夺走他们的工作，那些本来就持怀疑态度的人会彻底拒绝它。这将让好处永远难以兑现，这也是政府、包括医疗行业在内的各行各业以及 AI 公司现在就应该携手的另一个原因。
...
凭借综合各科学领域知识的能力，AI 可以加速世界上最棘手技术难题的创新：为所有人提供可靠的清洁能源、应对气候变化、生产足够的粮食、根除疾病等等。研究癌症治疗或核能的科研人员可以用 AI 检索海量科学文献，帮助他们发现人类可能忽略的模式，判断哪些实验最有前景。当智力不再像今天这样成为限制因素时，小公司将能够与研究预算大得多的机构竞争。研发和创新将被超级加速。
...
医疗是 AI 能够解决现实问题的领域之一。许多美国小型医院缺少能快速诊断急症患者的院内专家。在这些地方，AI 可以确保心脏病发作被及时发现，让一个家庭免于医疗紧急状况带来的沉重负担。Viz.ai 就是一个例子：它分析影像以发现中风和其他急症，并帮助医疗团队协调患者护理，已在美国近 2000 家医院投入使用。
...
AI 还将帮助全科医生做出更好的诊断，并在患者不在诊所时与他们保持联系。它也将帮助患者理解检查结果和复杂的服药安排。

> Agriculture is where I see the fastest impact of AI in low-income countries.

> 在低收入国家，农业是我看到 AI 影响最快的地方。
...
当我告诉别人，农业——第二个领域——是我在低收入国家看到 AI 影响最快的地方时，很多人感到惊讶。在大多数低收入国家，农民得不到可靠的天气预报，也得不到关于种什么种子、如何保护农作物和牲畜免受疾病侵害、如何改良土壤的建议。随着这些国家的人口增长和气候变化的挑战，农民比以往任何时候都更需要帮助。借助 AI，低收入国家的农民很快就能在这些方面获得比今天最富有的农民更好的建议，并大幅提高产量。
...
政府服务是 AI 能让人们生活更轻松的第三个领域。在美国，我见过一些家庭，他们被申请医疗保险、学生资助或食品援助的流程压得喘不过气——这可以理解。面对一大堆复杂的官僚表格，许多人几乎想放弃。AI 可以大幅简化流程，让他们更快获得所需帮助，政府也能更高效地运转。政府可以从最需要安全网服务的公民开始，大幅改善用户体验。
...
尽管我担心 AI 对心理健康的影响，但我也认为它能在这方面提供很大帮助。大多数社区的咨询师、精神科医生和成瘾治疗专家都不足。在适当的隐私保护下，AI 工具可以帮助人们识别警示信号；必要时，它们还能提供基于证据的应对策略，并与人类配合提供更及时的诊疗。
...
AI 对教育也是一大利好，尽管我之前提到过担忧。它可以解放教师，让他们有更多时间与学生进行一对一或小组辅导，并更清晰地看到整个班级的困难所在。对学生来说，一个保留研究人员所称"建设性挣扎"——即构建理解所需的认知劳动——的 AI 工具可以强化学习。当学生第一次接触新概念时，AI 给出实质性的解释，并同时提供问题和答案；之后在检查理解时，它扣住答案，引导学生自己得出。
...
综合起来，所有这些领域的进步可以让日常生活更轻松、更实惠，更少受个人收入和关系的限制。
...
AI 可以让个人和小企业获得今天需要昂贵专业帮助或庞大团队才能拥有的能力，同时让产品和服务变得更好、更便宜。它可以帮助残障人士更独立地生活，让有好点子的员工和创业者完成比今天多得多的成就。
...
最重要的是，它可以还人们一些时间与注意力——那些被文书工作、官僚程序、搜索可靠信息、以及付不起别人代劳的任务所消耗的时间与注意力。这些好处看起来可能不大，但乘以数百万人的生活，将是深远的：更多人在需要时得到好建议，并有更大自由去专注于他们想建立的生活。

> We have to be deliberate about ensuring that it benefits everyone and not just a wealthy few.

> 我们必须有意识地确保它惠及每个人，而不仅仅是少数富人。
...
在所有领域，关键词都是"可以"——AI *可以*改善每个收入阶层人们的生活。但它不会自动做到。与任何新技术一样，我们必须有意识地确保它惠及每个人，而不仅仅是少数富人。这需要政府和慈善事业发挥重要作用，让不那么富裕的公民和低收入国家成为充分受益者。
...
盖茨基金会将在 20 年中的剩余 19 年里花掉剩下的 2000 亿美元。AI 将通过加速发现针对艾滋病、结核病、疟疾和营养不良的疫苗与药物，并帮助医护工作者和患者学会使用这些工具，帮助基金会实现其雄心勃勃的目标。基金会的目标包括再次将每年死亡的儿童人数减半——正如 2000 年到 2024 年做到的那样。我们所有的工作——不仅健康，还有农业和教育——都将充分利用 AI。
...
下个月，我将在基金会年度《守门人》报告中详述这些努力——包括我们致力于让 AI 模型支持我们工作所在国家的语言，而不仅仅是富裕和中等收入国家常用的语言。包括 OpenAI、Anthropic、谷歌和微软在内的许多领先 AI 公司都在与基金会合作推进所有这些项目，这正在产生重大影响。

## The world needs a plan. — 世界需要一个计划。
...
一些 AI 公司正在为自身技术带来的挑战提出解决方案，这很好，但我们不应指望它们冲锋在前。有些问题超出了它们的专业领域，而且在民主社会中，决定这些事情也不是它们的角色。
...
相反，解决方案应该通过公开的民主程序来制定，让民选官员、政策制定者、教育工作者、卫生工作者、地方官员和社区领袖参与其中。数以百万计的人的生活将被扰乱，我们需要一个更强大、更灵活的社会安全网来帮助他们度过转型。地方社区已经在就数据中心所需的能源和水资源提出关切。如果没有解决方案，一些群体将推动完全停止 AI 的开发和部署。
...
解决方案应由我们对 AI 提出的深刻问题的回答来塑造，包括：在机器能比我们思考得更深入的时代，我们如何保持人性？作为终其一生思考"为人意味着什么"的人，宗教领袖可以在这方面发挥关键作用。教皇利奥十四世关于 AI 的通谕《[人工智能时代守护人格](https://www.vatican.va/content/leo-xiv/en/encyclicals/documents/20260515-magnifica-humanitas.html)》让我着迷，它为需要完成的工作奠定了坚实基础。
...
未来几个月，我将分享更多关于如何确保 AI 的好处大于危害的想法。先从三个开始，按我认为的重要性排序。

## Build a new system for managing the transition. — 建立一套管理过渡的新体系。

The highest priority is a monumental task: creating a domestic and international framework for dealing with AI.

最高优先级是一项艰巨的任务：建立一个国内和国际框架来应对 AI。
...
我们现有的任何机构都不是为处理一种传播如此之快、触及我们生活如此多方面的技术而设计的。所以我们需要建立新的机构。
...
再怎么说这项工程的浩大都不为过。9/11 袭击之后，美国政府进行了自二战以来最大规模的改组，目的只是改进一项职能——国家安全。
...
AI 需要的将多得多。它将影响国家安全，以及就业、教育、税收、能源、选举、空气和水、公共卫生、金融体系、执法、交通、公共土地和 IT 系统。
...
这些领域相互重叠，而我们现有的官僚体系并不是为管理这种重叠而设计的。劳工部门可能了解劳动力冲击，却不懂安全风险；商业监管机构可能了解市场集中度，却不懂 AI 对儿童和青少年的影响。如果放任不管，每个机构都只能看到系统的一部分，而 AI 的后果将波及整个系统。
...
在国家层面，各国将需要能够在政府各部门之间设定优先级的机构，目标是确保每一种风险都有人负责。否则，一次 AI 攻击可能会成功，就因为没人认为阻止它属于自己的职责。
...
但即使一个国家把自己的事情处理好，它仍将面临跨境风险。这就是为什么需要同步建立一个国际组织。
...
它将不同于我们创建过的任何机构，尽管它可以借鉴一些现有体系的模式：核武器有核查制度，国际航空有规章，臭氧层有保护协定。一个全新的全球 AI 组织需要这三者甚至更多要素。
...
我们有理由怀疑，世界现有机构是否有能力设计和实施这套新架构。政府行动缓慢，有时甚至毫无行动；国家内部和国家之间的两极分化让成事比以往更难。美国和中国之间需要某种程度的合作。
...
我们没有慢慢来的奢侈。起点应该是一个建立正确机构的进程，要在冲击迫使各国政府陷入危机模式之前。国家领导人应定期召集经济学家、技术专家、劳工专家、商界领袖和工人自己，识别现有机构在哪里失灵，以及可能需要哪些新权力机构。各国需要互相学习。
...
主办领先 AI 开发企业、掌控供应链关键环节的国家，应该现在就开会确立共同规范，趁竞争压力还没让合作变得更难。

Building the framework I’m talking about will take years, which is why we need to start now.

建立我说的这套框架需要数年时间，这就是为什么我们必须现在就开始。

## Set aside some jobs for humans. — 为人类保留一些工作。
...
我父亲于 2020 年因阿尔茨海默病去世。在病情晚期，昼夜照顾他的是受雇的护理人员——即使在他难以表达自己时，他们也能理解他。他并不总能告诉他们自己饿了，但他们总是知道。
...
我和家人将永远感激那支了不起的专业团队。他们照顾我父亲时所付出的某些东西，是无可替代的人性。没有机器人能够、也不应该去做这件事。
...
每当讨论哪些工作会消失、哪些会保留时，我都会想起那支团队。我相信，随着 AI 和机器人不断进步，我们会把某些事情留出来，只让人来做。我开始称这个领域为"人类保留区"，它是我们需要考虑的那类想法的一个例子。
...
我喜欢"人类保留区"这个说法，因为它让我想到自然保护区——那些地方本可以建楼房、修道路，但我们选择不这么做，因为失去的代价太大了。
...
我们可能出于经济原因把某些工作划入人类保留区。例如，允许机器接管某个角色会取代大量难以转行的人。你不能对一个在建筑行业干了一辈子的 55 岁工人说"你需要去养老院工作"，还指望他从中获得满足感。
...
有时，决定把某事划入人类保留区是出于其他因素。比如在医疗领域，想象一个机器人告诉你得了不治之症这个坏消息。从技术上讲，它完全可以做到。但它不应该。
...
人类保留区的范围会随着时间演变——例如，我们应该考虑现在先保留一些岗位，用几年或几十年的时间逐步引入 AI，同时承诺保留部分工作。教育和心理健康护理等领域将是混合模式：由人类主导，利用技术延伸他们能做的事。
...
划线的位置也会因地区而异。有些国家可能坚持由人类照顾老人。但像日本这样劳动力萎缩、没有足够年轻人照顾老人的国家，可能会欢迎护理机器人。
...
"人类保留区"的想法引出一连串我无法回答的问题。*谁来决定我们为人类保留什么？应该用什么标准？如何防止公司作弊、偷偷使用机器人？当一个国家让机器人制造某些东西而另一个国家不允许时，国际贸易会怎样？*这些问题需要在过渡计划中公开讨论解决。

## Rebalance how we tax labor and capital. — 重新平衡对劳动和资本的征税。
...
随着工人被推向不同的岗位，他们将需要再培训和社会安全网的其他支持。但他们的工作时间会更少，这意味着缴纳的所得税更少，而政府收入恰恰在这些服务需求最大的时候下降。在预算紧张的时候，资金总得有个来源。
...
我认为我们应该对 AI [代币](https://blogs.nvidia.com/blog/ai-tokens-explained/)和机器人征税。现在，如果你是雇主，雇一个人，你要为他们的收入缴纳工资税；但如果你买一个机器人，通常可以立刻把它作为企业开支抵扣。税收制度正在推动你用机器取代人。
...
征税会稍微减缓远离人类劳动力的步伐，并为再培训和更强大的安全网筹集资金。它需要有针对性，以免拖慢 AI 纯粹有益的用途，比如让医疗和教育更便宜。
...
这个想法的批评者指出，从经济角度看它并非最优效率，但他们没有考虑到工作对个人和社会的更广泛价值。而且，有了我们将拥有的所有加速创新，我们付得起一点效率损失，作为让民众保住工作的代价。
...
我多年前就提出过机器人税，当时大多数人的反应是这是个奇怪的想法。我至今仍是它的坚定支持者。虽然它不是应对 AI 威胁的全部答案，但它是明智应对的一部分。
...
无论我们如何为更多援助筹集资金，它都必须到达最需要的人手中，包括因 AI 和机器人失业的工人、工时或工资下降的人，以及损失集中的社区。我们现在就需要开始这项工作，以便在需求变得迫切时体系已经就绪。
...
我将用自己的声音和时间，把 AI 与公平问题推上公共议程。每次访问华盛顿特区，每当我与世界各地的领导人会面，我都会提出这个问题。与 AI 模型开发者交谈时，这也是我对话的重中之重。我将倡导我前面描述的国内和国际框架。盖茨基金会将推动 AI 的良性应用，包括在非洲。我创办的突破能源公司将利用 AI 帮助企业开发廉价清洁能源、帮助解决气候问题。我还会定期撰写关于 AI 的文章。
...
*你们现在有机会采取行动*，*趁失业率还没有急剧上升、社区还没有遭受重创、公众信任还没有被侵蚀。你们可以确保自己的政府整体性地处理这个问题，而不是把它肢解给多个官僚领地。你们可以确保 AI 惠及所有人。你们还可以与其他政府合作，共同应对这一国内和全球挑战。*
...
这项前所未有的技术，要求前所未有的全球回应。如果我们做对了，人类获得的回报将是惊人的，世界将变得更加公平。
...
我几乎无时无刻不在思考 AI——不是因为我有所有答案，而是因为它提出的问题太重要，不能留给一小群技术专家。学术界、商界、政府和公民社会的领袖，都有责任塑造接下来会发生什么。
